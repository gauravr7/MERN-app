         ...
         <div className="card card-body mb-3">
            <div className="row">
               ...
               <div className="col-md-10">
                  ...
                  {showActions ? (
                     <span><button type="button" onClick={this.onLikeclick.bind(this, post._id)} className="btn btn-light mr-1">
                        ...
                        {post.user === auth.user.id ? (<button type="button" onClick={this.onDeleteClick.bind(this, post._id)} className="btn btn-danger mr-1">
